...
import {CouncilWalletHTBBusiness23} from "./Campaign.sol";

contract SetupFSHTBBusiness23 {
    Crowdfunding public immutable TARGET;
    CouncilWalletHTBBusiness23 public immutable WALLET;
    ...
    constructor() payable {
        ...
        WALLET = new CouncilWalletHTBBusiness23(councilMembers);
