...
import {OwnershipFacetSEETF23} from "./facets/OwnershipFacet.sol";
import {DiamondLoupeFacet} from "./facets/DiamondLoupeFacet.sol";
import {FeatherCoinFacetSEETF23} from "./facets/FTCFacet.sol";
import {DAOFacetSEETF23} from "./facets/DAOFacet.sol";
import {PigeonVaultFacetSEETF23} from "./facets/PigeonVaultFacet.sol";
...
contract SetupPigeonVaultSEETF23 {
    DiamondCutFacet public diamondCutFacet;
    OwnershipFacetSEETF23 public ownershipFacet;
    DiamondLoupeFacet public diamondLoupeFacet;
    FeatherCoinFacetSEETF23 public ftcFacet;
    DAOFacetSEETF23 public daoFacet;
    PigeonVaultFacetSEETF23 public pigeonVaultFacet;
    ...
    constructor() payable {
        ...
        ownershipFacet = new OwnershipFacetSEETF23();
        diamondLoupeFacet = new DiamondLoupeFacet();
        ftcFacet = new FeatherCoinFacetSEETF23();
        daoFacet = new DAOFacetSEETF23();
        pigeonVaultFacet = new PigeonVaultFacetSEETF23();
    ...
    function claim() external {
        ...
        // bug: claimed should be set to true 
...
/* thinking
no way to change owner directly, so should be acheived by a delegatecall?

core: DAO and FTC

submit a proposal to add a new facet that has a function which could change the owner

how to get enough FTC to approve the proposal? 10000(claim) -> 100000(proposalThreshold/10)
*/