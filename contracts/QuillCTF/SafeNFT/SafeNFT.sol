...
contract SafeNFTQuill is ERC721Enumerable {
    uint256 price;
    ...
    function claim() external {
        ...
        _safeMint(msg.sender, totalSupply());    // checkOnERC721Received callback
        canClaim[msg.sender] = false;   // do not follow Checks-Effects-Interactions Pattern
    }
