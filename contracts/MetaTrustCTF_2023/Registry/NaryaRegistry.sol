...
contract NaryaRegistryMetaTrust23 {
    ...
    function register() public {
        ...
        balances[msg.sender] =    // 0xDA0 + 59425114757512643212875122
            0xDA0 +
    ...
    function pwn(uint256 _amount) public {
        ...
        if (balances[sender] >= _amount) {
            ...
            records2[sender] = _amount;  // Fibonacci
