...
contract ByteDanceMetaTrust23 {
    ...
    function checkCode(address _yourContract) public {
        ...
        for (uint256 i = 0; i < size; i++) {
            ...
            require(isOddByte(b), "Byte is not odd");  // just use odd bytecode
        }
        require(hasDanceByte, "No palindrome byte found");  // must have palindrome byte
